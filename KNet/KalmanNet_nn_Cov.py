...
class KalmanNetNN(torch.nn.Module):
    ...
    def InitKGainNet(self, prior_Q, prior_Sigma, prior_S, args):
        ...
        self.sigma_fc1 = nn.Linear(self.d_hidden_Sigma + self.d_hidden_S, self.d_hidden_Sigma).to(self.device)
    ...
    def step_KGain_est(self, y):
        ...
        KG, SigmaPosterior = self.KGain_step(obs_diff, obs_innov_diff, fw_evol_diff, fw_update_diff)
    ...
    def KNet_step(self, y):
        ...
        # Compute Kalman Gain
        SigmaPosterior = self.step_KGain_est(y)
        ...
        # return
        return self.m1x_posterior, SigmaPosterior
    ...
    def KGain_step(self, obs_diff, obs_innov_diff, fw_evol_diff, fw_update_diff):
        ...
        # sigma head
        in_sigma_fc1 = torch.cat((out_Sigma, out_S), 2)
        SigmaPosterior = self.sigma_fc1(in_sigma_fc1)

        # print(sigma1.shape, sigma2.shape, torch.matmul(sigma1, sigma2).shape)
        return out_FC2, SigmaPosterior
